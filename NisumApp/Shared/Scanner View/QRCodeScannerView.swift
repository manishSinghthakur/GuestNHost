...
public struct QRCodeScannerView: UIViewRepresentable {
    ...
    public func makeUIView(context: UIViewRepresentableContext<QRCodeScannerView>) -> QRCodeScannerView.UIViewType {
        let view = BarcodeView()
        view.onGenerated = self.onGenerated
        return view
    }

    public func updateUIView(_ uiView: BarcodeView, context: UIViewRepresentableContext<QRCodeScannerView>) {
...
public class BarcodeView: UIImageView {
    ...
    private var barcodeType: QRCodeScannerView.BarcodeType?
    var onGenerated: QRCodeScannerView.OnBarcodeGenerated?
    
    func gen(data: String?, barcodeType: QRCodeScannerView.BarcodeType) {
    ...
    func rotate(orientation: QRCodeScannerView.Orientation) {
